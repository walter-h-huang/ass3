 ...
 * CLIENT THEN LOOPS THIS REQUEST ~5 TIMES (~15 SECONDS)
 *
 *
 * INPUT: "date; ls -l junk.txt; rm -f junk.txt; ls -l junk.txt"
 * SLEEP 5
 *
 *
 *
...
*/	
	int counter = 1;
	printf("Looping: \"date; ls -l junk.txt; rm -f junk.txt; ls -l junk.txt\"\n");
	char sendline[MAXLINE] = "date; ls -l junk.txt; rm -f junk.txt; ls -l junk.txt";
