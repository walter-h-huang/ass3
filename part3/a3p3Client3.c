 ...
 * CLIENT THEN LOOPS THIS REQUEST ~15 TIMES (~15 SECONDS)
 *
 *
 * INPUT: "date; ls -l junk.txt; uname -a"
 * SLEEP 1
 *
 *
 *
...
//	else
	...
	int counter = 1;
	printf("Looping: \"date; ls -l junk.txt; uname -a\"\n");
	char sendline[MAXLINE] = "date; ls -l junk.txt; uname -a";
